...
= 2.2.0 (Sep 12, 2026) =
* [Feature] Introduced Build with AI, Create websites using AI-powered prompts.

= 2.1.9 (Sep 01, 2026) =
* [Bug-Fix] Fixed a stored XSS through the Custom Attributes and link attributes fields, where an event handler saved by a lower privileged user could be served to visitors. Attribute names are now checked against a list of supported names on every render path, and event handlers render only for content saved by a user who is allowed to add JavaScript.
* [Bug-Fix] Fixed color picker popup and positioning issue in Website settings page.

= 2.1.8 (August 17, 2026) =
* [Bug-Fix] Enhanced security checks to improve overall stability and protection.

= 2.1.7 (August 6, 2026) =
* [Feature] Added PageLayer MCP (Beta) feature.
* [Bug-Fix] Added an XSS warning notice while editing posts and pages, and enhanced security checks.
...
= 2.1.2 (June 09, 2026) =
* [Task] Updated version to 2.1.2 due to WordPress API update issue.

= 2.1.1 (June 09, 2026) =
* [Improvement] Plugin settings UI updated.
* [Bug Fix] Fixed some warnings with PHP 8.2+.
* [Task] Tested with WordPress 7.0

= 2.1.0 (April 09, 2026) =
* [Bug Fix] Improved XSS security checks.
* [Bug Fix] Inline editor has been further improved.
